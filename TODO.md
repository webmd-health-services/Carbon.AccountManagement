...
* Rename every file that has `Carbon.AccountManagement` in its name, replacing `Carbon.AccountManagement` with the module name.
* Replaces `Carbon.AccountManagement` in every file with the module name.
